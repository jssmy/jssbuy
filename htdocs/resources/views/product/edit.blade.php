        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::open(['route'=>['product.update',$product->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true]) !!}
                         <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            {!! Form::label('name','Nombre',['class'=>'col-md-4 control-label']) !!}
                                <div class="col-md-6">
                                    {!! Form::text('name',$product->name,['class'=>'form-control','required'=>'requerid','autfocus'=>'autofocus']) !!}
                                    @if ($errors->has('name'))
                         ...
                         <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">  
                           {!! Form::label('description','Descripcion',['class'=>'col-md-4 control-label']) !!}
                                <div class="col-md-6">
                                    {!! Form::text('description',$product->description,['class'=>'form-control','required'=>'required','autofocus'=>'autofocus'])  !!}
                        ...
                        <div class="form-group{{ $errors->has('unit_price') ? ' has-error' : '' }}">  
                           {!! Form::label('unit_price','Precio unitario ( S/. )',['class'=>'col-md-4 control-label']) !!}
                                <div class="col-md-6">
                                    {!! Form::number('unit_price',$product->unit_price,['class'=>'form-control','required'=>'required','autofocus'=>'autofocus','placeholder'=>'0.00 S/.'])  !!}
                        ...
                        <div class="form-group{{ $errors->has('stock') ? ' has-error' : '' }}">  
                           {!! Form::label('stock','Stock',['class'=>'col-md-4 control-label']) !!}
                                <div class="col-md-6">
                                    {!! Form::number('stock',$product->stock,['class'=>'form-control','required'=>'required','autofocus'=>'autofocus'])  !!}
                                    @if ($errors->has('stock'))
                                        <span class="help-block">
